            ...
            authenticate("auth-basic") {
                route("/qpoints"){
                    route("/discord") {
                        ...
                        permPatch("/transfert/{User1}/{User2}",
                            AccessToken.EPermission.DISCORD_MANAGE_QPOINTS){
                            val user1 = call.parameters["User1"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Discord User1 is required")
                            val user2 = call.parameters["User2"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Discord User2 is required")
                            val qpoints = call.request.queryParameters["qpoints"]?.toIntOrNull() ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "qpoints parameter is required")
                        ...
                        permGet("/{User}",
                            ...
                            val user = call.parameters["User"] ?: return@permGet call.respond(HttpStatusCode.BadRequest, "Discord User is required")
                    ...
                    route("/twitch") {
                        ...
                        permPatch("/transfert/{User1}/{User2}",
                            AccessToken.EPermission.TWITCH_MANAGE_QPOINTS){
                            val user1 = call.parameters["User1"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Twitch User1 is required")
                            val user2 = call.parameters["User2"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Twitch User2 is required")
                            val qpoints = call.request.queryParameters["qpoints"]?.toIntOrNull() ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "qpoints parameter is required")
                        ...
                        permGet("/{User}",
                            ...
                            val user = call.parameters["User"] ?: return@permGet call.respond(HttpStatusCode.BadRequest, "Twitch User is required")
                    ...
                    permPatch("/link/{TwitchUser}/{DiscordUser}",
                        AccessToken.EPermission.LINK_TWITCH_DISCORD){
                        val twitchUser = call.parameters["TwitchUser"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Twitch User is required")
                        val discordUser = call.parameters["DiscordUser"] ?: return@permPatch call.respond(HttpStatusCode.BadRequest, "Discord User is required")
                ...
                route("/admin") {
                    permRoute("/keys",
                        ...
                        post {
                            ...
                            AccessToken.create(newKey.user, newKey.key, AccessToken.EPermission.fromInt(newKey.permissions))
                            call.respond(HttpStatusCode.OK)
                        }
                        delete {
